#!/bin/zsh
# ============================================
# Build and Deploy Script for ResumeMate Backend
# ============================================
set -e
...
# Configuration
DOCKER_IMAGE_NAME="${DOCKER_IMAGE_NAME:-resumemate-backend}"
...
show_usage() {
    ...
    echo "  DOCKER_IMAGE_NAME      Image name (default: resumemate-backend)"
